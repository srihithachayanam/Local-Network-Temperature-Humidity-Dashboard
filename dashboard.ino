...
void setup() {
  ...
  Serial.println("✓ ML-powered web server ready!");
}
...
<body>
  <div class="container">
    <h1>🤖 ML Climate Monitor</h1>
    <div class="subtitle">Machine Learning Powered Analytics</div>
    
    <div class="grid">
      <div class="card">
        <div class="card-header"><span class="card-icon">🌡️</span>Temperature</div>
      ...
      <div class="card">
        <div class="card-header"><span class="card-icon">💧</span>Humidity</div>
      ...
      <div class="card ml-card">
        <div class="card-header"><span class="card-icon">🔮</span>Predictions (1h)</div>
        <div class="ml-metric">
    ...
    <div class="card">
      <div class="card-header"><span class="card-icon">😊</span>Comfort Index</div>
    ...
    <div id="anomalyAlert" style="display: none;" class="anomaly">
      ⚠️ <strong>Anomaly Detected:</strong> <span id="anomalyMsg"></span>
    </div>
  </div>
